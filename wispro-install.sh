...
BMU_ULOGD_VERSION="1.0"
BMU_LOGSTASH_VERSION="1.0"
...
docker pull wispro/bmu_ulogd:${BMU_ULOGD_VERSION}
docker pull wispro/bmu_logstash:${BMU_LOGSTASH_VERSION}
